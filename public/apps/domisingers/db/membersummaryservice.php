...
class MemberSummaryService {
	...
	public function findByResponsibility($responsibilityId) {
		$sql = "SELECT kausi, etunimi, sukunimi 
			FROM viskaalius 
			LEFT JOIN jasen
			ON viskaaliudet.person_id = jasen.person_id
			WHERE viskaalius_id = $responsibilityId;";
