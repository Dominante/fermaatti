...
INSERT INTO `oc_jobs` VALUES (1,'OCA\\Activity\\BackgroundJob\\EmailNotification','null',1439051409),(2,'OCA\\Activity\\BackgroundJob\\ExpireActivities','null',1439049617),(3,'OCA\\Files_sharing\\Lib\\DeleteOrphanedSharesJob','null',1439051394);
...
INSERT INTO `oc_preferences` VALUES ('admin','firstrunwizard','show','0'),('admin','login','lastLogin','1439048593');
...
INSERT INTO `oc_storages` VALUES ('home::admin',1),('local::/var/www/public/data/',2);
...
INSERT INTO `oc_users` VALUES ('admin',NULL,'1|$2y$10$k3jSPG9quxy3ldd8amS/W..mHf3iNIeKplAkDd7Iw4BIuviRfA6RO');
